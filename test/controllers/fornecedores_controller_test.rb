...
class FornecedoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fornecedore" do
    assert_difference("Fornecedore.count") do
      post fornecedores_url, params: { fornecedore: { cnp: @fornecedore.cnp, endereco: @fornecedore.endereco, nome: @fornecedore.nome } }
    end
  ...
  test "should update fornecedore" do
    patch fornecedore_url(@fornecedore), params: { fornecedore: { cnp: @fornecedore.cnp, endereco: @fornecedore.endereco, nome: @fornecedore.nome } }
